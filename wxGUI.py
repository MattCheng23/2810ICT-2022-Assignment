...
class MainWindow(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.lbldd = wx.StaticText(panel, label="Start Date:", pos=(20, 110))
        self.editdd = wx.TextCtrl(panel, value="Enter a date", pos=(100, 110), size=(140, -1))
        self.Bind(wx.EVT_TEXT, self.EvtText, self.editdd)
        self.Bind(wx.EVT_CHAR, self.EvtChar, self.editdd)

        self.lblmm = wx.StaticText(panel, label="End Date:", pos=(20, 140))
        self.editmm = wx.TextCtrl(panel, value="Enter a date", pos=(100, 140), size=(140, -1))
